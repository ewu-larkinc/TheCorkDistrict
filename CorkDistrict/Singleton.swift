...
class Singleton {
    ...
    func getWineries() -> [NSManagedObject] {
        ...
        if let results = fetchedResults {
            ...
            winery1.setValue("Spokane, WA", forKey: "city")
            winery1.setValue("WA", forKey: "state")
            ...
            winery2.setValue("Spokane, WA", forKey: "city")
            winery2.setValue("WA", forKey: "state")
            ...
            winery3.setValue("Spokane, WA", forKey: "city")
            winery3.setValue("WA", forKey: "state")
            ...
            winery4.setValue("Spokane Valley, WA", forKey: "city")
            winery4.setValue("WA", forKey: "state")
            ...
            winery5.setValue("Liberty Lake, WA", forKey: "city")
            winery5.setValue("WA", forKey: "state")
            ...
            winery6.setValue("Spokane Valley, WA", forKey: "city")
            winery6.setValue("WA", forKey: "state")
            ...
            winery7.setValue("Spokane, WA", forKey: "city")
            winery7.setValue("WA", forKey: "state")
            ...
            winery8.setValue("Spokane, WA", forKey: "city")
            winery8.setValue("WA", forKey: "state")
            ...
            winery9.setValue("Spokane, WA", forKey: "city")
            winery9.setValue("WA", forKey: "state")
            ...
            winery10.setValue("Spokane, WA", forKey: "city")
            winery10.setValue("WA", forKey: "state")
            ...
            winery11.setValue("Spokane, WA", forKey: "city")
            winery11.setValue("WA", forKey: "state")
            ...
            winery12.setValue("Spokane, WA", forKey: "city")
            winery12.setValue("WA", forKey: "state")
            ...
            winery13.setValue("Spokane, WA", forKey: "city")
            winery13.setValue("WA", forKey: "state")
            ...
            winery14.setValue("Spokane, WA", forKey: "city")
            winery14.setValue("WA", forKey: "state")
            ...
            winery15.setValue("Colbert, WA", forKey: "city")
            winery15.setValue("WA", forKey: "state")
            ...
            winery16.setValue("Spokane, WA", forKey: "city")
            winery16.setValue("WA", forKey: "state")
            ...
            winery17.setValue("Spokane, WA", forKey: "city")
            winery17.setValue("WA", forKey: "state")
