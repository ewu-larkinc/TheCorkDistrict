...
class Singleton {
    ...
    func getWineries() -> [NSManagedObject] {
        ...
        if (wineries.count > 0) {
            ...
            winery11.setValue(UIImageJPEGRepresentation(myImage2, 1), forKey: "imageData")
            ...
            winery12.setValue(UIImageJPEGRepresentation(myImage2, 1), forKey: "imageData")
            ...
            winery13.setValue(UIImageJPEGRepresentation(myImage2, 1), forKey: "imageData")
            ...
            winery14.setValue(UIImageJPEGRepresentation(myImage2, 1), forKey: "imageData")
            ...
            winery15.setValue(UIImageJPEGRepresentation(myImage2, 1), forKey: "imageData")
            ...
            winery16.setValue(UIImageJPEGRepresentation(myImage2, 1), forKey: "imageData")
            ...
            winery17.setValue(UIImageJPEGRepresentation(myImage2, 1), forKey: "imageData")
